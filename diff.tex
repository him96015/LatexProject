...
}\DIFaddend their daily life [1]. The number of devices that are connected to the Internet has
...
[3].  \DIFdelbegin \DIFdel{These uniquely identifiable objects and devices move and interact with each
other to accomplish various tasks. }\DIFdelend In other words, IoT is like a big and dynamic
...
\DIFaddbegin \DIFadd{e divided proxemic interactions into two levels:
...
communication in 1966 [6]. \DIFdelbegin \DIFdel{He divided proxemic interactions into two levels:
micro-level, which studies the way people interact with each other in daily life
and macro-level, which }\DIFdelend \DIFaddbegin \DIFadd{H, which }\DIFaddend reviews the space organization of houses, buildings and
ultimately towns\DIFaddbegin \DIFadd{.These uniquely identifiable objects and devices move and interact with each
other to accomplish various tasks}\DIFaddend . More recently, Greenberg et al. proposed a practical version
